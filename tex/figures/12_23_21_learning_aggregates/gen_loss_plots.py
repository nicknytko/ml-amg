...
train_baseline = load_data('Dec21_19-51-52_nick-arch_Loss_Train_Lloyd_SA.csv')
train_ml = load_data('Dec21_19-51-52_nick-arch_Loss_Train_ML.csv')
test_baseline = load_data('Dec21_19-51-52_nick-arch_Loss_Test_Lloyd_SA.csv')
test_ml = load_data('Dec21_19-51-52_nick-arch_Loss_Test_ML.csv')
